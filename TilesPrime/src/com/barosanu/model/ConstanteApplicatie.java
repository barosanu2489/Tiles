...
public class ConstanteApplicatie {
	...
	public static final int PROGRAMARE_GENERALA = 0;
	public static final int SAPTAMANA_CURENTA = 1;
	public static final int SAPTAMANA_VIITOARE = 2;
	public static final int PESTE_2_SAPTAMANI = 3;
	public static final int PESTE_3_SAPTAMANI = 4;
